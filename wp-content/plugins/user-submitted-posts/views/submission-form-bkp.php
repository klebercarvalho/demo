...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" data-validate="parsley" enctype="multipart/form-data" action="" novalidate>
		...
		<fieldset class="usp-name">
			...
			<!-- <input name="user-submitted-name" type="hidden" value="" data-required="true" placeholder="<?php _e('Your Name', 'usp'); ?>" class="usp-input"> -->
			<input name="user-submitted-name" type="text" value="<?php echo $vaga; ?>" data-required="false" placeholder="" class="usp-input">
			<?php } else { ?>
