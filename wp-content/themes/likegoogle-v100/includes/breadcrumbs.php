...
if(sith_get_option('breadcrumbs')){
  ...
  if ( !is_home() && !is_front_page() || is_paged() ) {
    ...
    if ( is_category() ) {
      ...
      echo $before ;
	  echo lang_search_results_for; echo': ';printf(get_search_query() );
	  echo  $after;
 
    } elseif ( is_tag() ) {
	  echo $before ;
	  echo lang_tag_archives; printf(single_tag_title( '', false ) );
	  echo  $after;
      ...
      echo $before ;
	  echo lang_author_archives; printf($userdata->display_name );
	  echo  $after;
