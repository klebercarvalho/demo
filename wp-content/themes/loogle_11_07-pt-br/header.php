	...
	<!--  Top links ends-->
		...
		<table cellpadding="0" cellspacing="0" id="header" width="100%">
			...
			<?php if( get_option('loogle_logo') && get_option('loogle_logo_header') == "yes" )  { ?>
				...
				<a href="<?php bloginfo('url'); ?>/"><img src="<?php echo  get_stylesheet_directory_uri();?>/images/logo.png" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('name'); ?>" width="123 height="43" /></a> 		
		...
		<tr>
			...
			<td class="side_bar left_bar">
				...
				<ul>
						...
						<li><a href="http://twitter.com/<?php echo get_option('loogle_twitter');?>"  class="twitter" title="Twitter" >Twitter</a></li>
						<li><a href="http://myspace.com/<?php echo get_option('loogle_myspace');?>"  class="myspace"title="Myspace" >Myspace</a></li>
